...
export default function VideoPlayer({ videoUrl, isLoading }: VideoPlayerProps) {
    ...
    return (
        <motion.div
            ...
            className="w-full max-w-2xl aspect-video bg-black/40 rounded-xl overflow-hidden flex items-center justify-center border border-white/10 shadow-2xl backdrop-blur-md"
        >
            {isLoading ? (
