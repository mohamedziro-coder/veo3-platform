            ...
            <div className="max-w-5xl mx-auto space-y-24">
                <section className="flex flex-col md:flex-row items-center gap-12">
                    <div className="flex-1">
                        ...
                        <p className="text-muted-foreground text-lg leading-relaxed">
                            We believe creativity is a human right. Traditional video production is gated by expensive equipment and steep learning curves.
                            Virezo breaks down these walls, giving every creator a Hollywood studio in their browser.
                        </p>
                    </div>
                ...
                <section className="flex flex-col md:flex-row-reverse items-center gap-12">
                    <div className="flex-1">
                        ...
                        <p className="text-muted-foreground text-lg leading-relaxed">
                            With great power comes great responsibility. We are committed to ethical AI development, ensuring our tools
                            are used for positive expression. We label AI-generated content and strictly prohibit deepfakes or misinformation.
                        </p>
                    </div>
