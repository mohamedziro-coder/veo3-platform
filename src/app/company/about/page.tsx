        ...
        <main className="min-h-screen pt-32 pb-20 px-6">
            ...
            <div className="max-w-4xl mx-auto text-center mb-24">
                <h1 className="text-5xl md:text-7xl font-black text-foreground mb-8">
                    We Are <span className="text-primary">Virezo</span>
                </h1>
                <p className="text-xl text-muted-foreground leading-relaxed">
                    Virezo is on a mission to democratize video production. We believe that everyone has a story to tell,
                    and cost or technical skills shouldn't be a barrier. Our AI-powered platform empowers creators,
                    brands, and agencies to produce broadcast-quality video content in minutes, not days.
                </p>
            </div>
            ...
            <div className="max-w-4xl mx-auto text-center">
                ...
                <div className="space-y-12 relative border-l-2 border-card-border ml-6md:ml-0 md:pl-0">
                    {[
