    ...
    return (
        <main className="min-h-screen pt-32 pb-20 px-6">
            <div className="max-w-4xl mx-auto text-center mb-24">
                <h1 className="text-5xl md:text-6xl font-black text-primary mb-8">Build the Future With Us</h1>
                <p className="text-xl text-muted-foreground">{"We're a remote-first team of engineers, designers, and dreamers."}</p>
            </div>
            ...
            <div className="max-w-5xl mx-auto">
                ...
                <div className="mt-12 text-center p-8 rounded-2xl bg-secondary/10 border border-secondary/20">
                    ...
                    <button className="text-primary font-bold hover:underline">Send Open Application</button>
                </div>
            </div>
        </main>
    );
