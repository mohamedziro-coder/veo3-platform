        ...
        <main className="min-h-screen flex flex-col items-center justify-center p-4 md:p-8 relative overflow-hidden pt-24 pb-32 bg-gray-50">
            ...
            >
                ...
                <motion.div variants={itemVariants} className="text-center space-y-4">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white border border-gray-200 text-xs font-medium text-cyan-600 shadow-sm">
                    ...
                    <p className="text-gray-500 text-lg max-w-2xl mx-auto leading-relaxed">
                        Transform text to professional voice. <br />
                ...
                <motion.div
                    ...
                    className="w-full bg-white border border-gray-200 shadow-xl rounded-[2rem] p-6 md:p-8 space-y-6"
                >
                    {/* Language + Gender Row */}
                    <div className="flex flex-col sm:flex-row gap-4">
                        ...
                        <div className="w-full sm:w-48 space-y-1">
                            ...
                            <div className="flex rounded-xl border border-gray-200 overflow-hidden h-[46px]">
                                <button
                    ...
                    <div className="p-4 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl border border-blue-100 flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-500">
                                Preset: <span className="font-mono text-blue-600">{resolveVoice(selectedLang, selectedGender)}</span>
                            </p>
                        </div>
                    </div>
                    ...
                    {/* Script Textarea */}
                    <div>
                        <label className="text-sm font-semibold text-gray-700 mb-2 block">Script</label>
                        <textarea
                            placeholder="Enter your script here..."
                            value={text}
                            onChange={(e) => setText(e.target.value)}
                            className="w-full h-40 bg-gray-50 rounded-xl p-4 border border-gray-200 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary text-base resize-none leading-relaxed shadow-inner"
                        />
                    </div>
                    ...
                    <div className="flex justify-between items-center border-t border-gray-100 pt-4">
                        ...
                        <button
                            ...
                            className="px-8 py-3 rounded-xl bg-gradient-to-r from-blue-500 to-cyan-500 font-bold text-white shadow-lg hover:shadow-cyan-500/40 disabled:opacity-50 disabled:cursor-not-allowed transition-all hover:scale-105 active:scale-95 flex items-center gap-2"
                        >
                            {isLoading ? (
                                <>
                    ...
                    {audioUrl && (
                        <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl border border-gray-200">
                            ...
                            <div className="flex-1">
                                <p className="text-sm font-semibold text-gray-800">Audio Ready</p>
                                <p className="text-xs text-gray-500">{LANGUAGES.find((l) => l.code === selectedLang)?.label} — {selectedGender === "man" ? "Male" : "Female"}</p>
                            </div>
                            <a
                                href={audioUrl}
                                download="virezo-voice.mp3"
                                className="px-4 py-2 rounded-lg bg-gray-800 text-white text-sm font-semibold hover:bg-gray-700 transition-all"
                            >
                                Download
                            </a>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <p className="text-xl text-gray-500 mb-8 leading-relaxed">
                                Neural AI captures breath, intonation, and emotion — indistinguishable from a real human recording.
                            </p>
                            <ul className="space-y-4">
                                {["14+ languages supported", "Male & Female voices", "Instant generation", "Commercial usage rights"].map((item, i) => (
                ...
                <div className="mt-24 w-full max-w-6xl">
                    <h2 className="text-4xl font-black text-center text-gray-900 mb-12">Perfect For...</h2>
                ...
                {/* FAQ */}
                <div className="mt-24 w-full max-w-4xl pb-20">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {[
                            ...
                            { q: "How many languages are supported?", a: "We support 14+ languages including Arabic, French, Spanish, German, and Japanese." },
