            ...
            <div className="max-w-6xl mx-auto">
                <div className="text-center max-w-3xl mx-auto mb-20">
                    ...
                    <h1 className="text-5xl md:text-7xl font-black text-foreground mb-6">
                        Your Brand's Voice, <br /> Everywhere.
                    </h1>
                    <p className="text-xl text-muted-foreground">
                        Ensure every piece of content aligns with your guidelines.
                        Train custom AI models on your brand's look and tone.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-32 items-center">
                    ...
                    <div className="order-1 md:order-2 h-[500px] bg-gradient-to-tr from-secondary/20 to-primary/20 rounded-[3rem] flex items-center justify-center">
